...
VALUES (
        'Эндокринолог',
        'Специалист по диагностике и лечению заболеваний эндокринной системы.'
    ),
    (
        'Диабетолог',
        'Врач, специализирующийся именно на лечении сахарного диабета и его осложнений.'
    ),
    (
        'Подолог',
        'Специалист по уходу за стопой, критически важный при профилактике "диабетической стопы".'
    ),
    (
        'Диетолог',
        'Помогает составить индивидуальный план питания для контроля уровня сахара.'
    );