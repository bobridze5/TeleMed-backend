create TABLE patients (
    ...
    patient_daily_calories_goal INTEGER,
    patient_daily_protein_goal DOUBLE PRECISION,
    patient_daily_fats_goal DOUBLE PRECISION,
    patient_daily_carbs_goal DOUBLE PRECISION,
